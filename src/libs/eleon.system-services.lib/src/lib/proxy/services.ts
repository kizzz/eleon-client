...
import { TenantAppearanceService } from './eleon/system-services/module/full/eleon/system-services-module/module/http-api/controllers/tenant-appearance.service';
...
export const PROXY_SERVICES = [SessionService, SystemLogService, TenantAppearanceService, WebPushService, CurrencyService];