...
import type { CreateSystemLogDto } from '../../application/contracts/system-log/models';
...
export class SystemLogService {
  ...
  writeMany(logs: CreateSystemLogDto[], config?: Partial<any>): Observable<boolean> {
    // baseUrl is already a quoted literal
		const apiBase = window?.['apiBase']?.['eleonauth'] || '';
    const baseUrl = apiBase + '/api/system-services/system-log/WriteMany';
