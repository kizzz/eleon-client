...
import type { WebPushSubscriptionDto } from '../../application/contracts/web-push/models';
...
export class WebPushService {
  ...
  addWebPushSubscription(subscription: WebPushSubscriptionDto, config?: Partial<any>): Observable<boolean> {
    // baseUrl is already a quoted literal
		const apiBase = window?.['apiBase']?.['eleonauth'] || '';
    const baseUrl = apiBase + '/api/system-services/web-push/AddWebPushSubscription';
