...
export const PROXY_SERVICES = [FeaturesService, IdentitySettingService, ProfileService, UserProfilePictureService, OrganizationUnitQueryingService, TenantQueryingService, TenantSettingsService, UserSettingsService, RoleQueryingService, UserQueryingService];