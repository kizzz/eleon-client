...
import type { StateActorAuditDto } from '../../dto/audits/models';

import { Observable } from 'rxjs/internal/Observable';


export class StateActorAuditService {
  ...
  addByStateActorAudit(stateActorAudit: StateActorAuditDto, config?: Partial<any>): Observable<boolean> {
    // baseUrl is already a quoted literal
		const apiBase = window?.['apiBase']?.['eleonsoft'] || '';
    const baseUrl = apiBase + '/api/Lifecycle/Audits/StateActor/Add';
    ...
    const options: RequestInit = {
      ...
      body: JSON.stringify(stateActorAudit),
  ...
  removeById(id: string, config?: Partial<any>): Observable<boolean> {
    // baseUrl is already a quoted literal
		const apiBase = window?.['apiBase']?.['eleonsoft'] || '';
    const baseUrl = apiBase + '/api/Lifecycle/Audits/StateActor/Remove';
