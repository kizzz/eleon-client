...
export class ActionService {
  ...
  add(action: ActionDto, config?: Partial<any>): Observable<ActionDto> {
    // baseUrl is already a quoted literal
		const apiBase = window?.['apiBase']?.['eleonsoft'] || '';
    const baseUrl = apiBase + '/api/JobScheduler/Actions/Add';
    ...
    return new Observable<ActionDto>(subscriber => {
          ...
          const contentType = res.headers.get("Content-Type") || "";
					if (contentType.includes("application/json")) {
						return res.json().then(data => {
							subscriber.next(data as ActionDto);
							subscriber.complete();
						});
					} else {
  ...
  delete(id: string, config?: Partial<any>): Observable<boolean> {
    // baseUrl is already a quoted literal
		const apiBase = window?.['apiBase']?.['eleonsoft'] || '';
    const baseUrl = apiBase + '/api/JobScheduler/Actions/Delete';
  ...
  getById(id: string, config?: Partial<any>): Observable<ActionDto> {
    // baseUrl is already a quoted literal
		const apiBase = window?.['apiBase']?.['eleonsoft'] || '';
    const baseUrl = apiBase + '/api/JobScheduler/Actions/GetById';
  ...
  getList(request: ActionListRequestDto, config?: Partial<any>): Observable<ActionDto[]> {
    // baseUrl is already a quoted literal
		const apiBase = window?.['apiBase']?.['eleonsoft'] || '';
    const baseUrl = apiBase + '/api/JobScheduler/Actions/GetList';
  ...
  update(action: ActionDto, config?: Partial<any>): Observable<ActionDto> {
    // baseUrl is already a quoted literal
		const apiBase = window?.['apiBase']?.['eleonsoft'] || '';
    const baseUrl = apiBase + '/api/JobScheduler/Actions/Update';
