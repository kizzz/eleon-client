...
export class TenantClientIsolationService {
  ...
  setTenantIpIsolationSettingsByRequest(request: SetIpIsolationRequestDto, config?: Partial<any>): Observable<boolean> {
    // baseUrl is already a quoted literal
		const apiBase = window?.['apiBase']?.['eleonsoft'] || '';
    const baseUrl = apiBase + '/api/eleoncore-multi-tenancy/ClientIsolation/SetTenantIpIsolationSettings';
  ...
  setTenantIsolationByRequest(request: SetTenantIsolationRequestDto, config?: Partial<any>): Observable<boolean> {
    // baseUrl is already a quoted literal
		const apiBase = window?.['apiBase']?.['eleonsoft'] || '';
    const baseUrl = apiBase + '/api/eleoncore-multi-tenancy/ClientIsolation/SetTenantIsolation';
  ...
  validateClientIsolationByValidateClientIsolationDto(validateClientIsolationDto: ValidateClientIsolationDto, config?: Partial<any>): Observable<boolean> {
    // baseUrl is already a quoted literal
		const apiBase = window?.['apiBase']?.['eleonsoft'] || '';
    const baseUrl = apiBase + '/api/eleoncore-multi-tenancy/ClientIsolation/ValidateClientIsolation';
    ...
    const options: RequestInit = {
      ...
      body: JSON.stringify(validateClientIsolationDto),
