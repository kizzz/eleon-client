...
import type { WebPushSubscriptionDto } from '../web-push/models';
...
export class WebPushService {
  ...
  addWebPushSubscriptionBySubscription(subscription: WebPushSubscriptionDto, config?: Partial<any>): Observable<boolean> {
    // baseUrl is already a quoted literal
		const apiBase = window?.['apiBase']?.['eleonsoft'] || '';
    const baseUrl = apiBase + '/api/Notificator/WebPush/AddWebPushSubscription';
