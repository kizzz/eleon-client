...
export class NotificationsService {
  ...
  send(input: NotificationDto, config?: Partial<any>): Observable<boolean> {
    // baseUrl is already a quoted literal
		const apiBase = window?.['apiBase']?.['eleonsoft'] || '';
    const baseUrl = apiBase + '/api/Notificator/Notifications/Send';
  ...
  sendBulk(input: NotificationDto[], config?: Partial<any>): Observable<boolean> {
    // baseUrl is already a quoted literal
		const apiBase = window?.['apiBase']?.['eleonsoft'] || '';
    const baseUrl = apiBase + '/api/Notificator/Notifications/SendBulk';
