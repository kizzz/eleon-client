...
@Component({
  selector: 'app-subapplications-table',
  standalone: true,
  imports: [
    SharedModule,
    TreeTableModule,
  ...
  templateUrl: './subapplications-table.component.html',
  styleUrls: ['./subapplications-table.component.css'],
})
export class SubapplicationsTableComponent implements OnInit {
