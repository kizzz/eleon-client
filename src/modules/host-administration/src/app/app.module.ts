...
import { LocationsDashboardComponent } from './application-management/locations-dashboard/locations-dashboard.component';

export const remoteRoutes: Route[] = [
  {
    path: 'sites/location-management',
    component: LocationsDashboardComponent,
    canActivate: [EcAuthGuard, PermissionGuard],
    data: {
      requiredPolicy: 'Permission.HostAdministration',
      type: 'application-management',
      name: 'TenantManagement::Locations',
  ...
  providers: [
    ...
    provideLocalizationOnInitialization(
      (culture) =>
        `${extractApiBase(
          'eleoncore'
        )}/api/abp/application-localization?cultureName=${culture}`,
