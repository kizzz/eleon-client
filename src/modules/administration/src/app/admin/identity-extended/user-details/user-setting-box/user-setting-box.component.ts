...
@Component({
  standalone: false,
  selector: 'app-user-setting-box',
  templateUrl: './user-setting-box.component.html',
  styleUrl: './user-setting-box.component.scss'
})
export class UserSettingBoxComponent implements OnInit{
